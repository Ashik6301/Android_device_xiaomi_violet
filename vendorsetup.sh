...
git clone --depth 1 https://Ashik6301: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@github.com/project-poison/android_kernel_xiaomi_violet.git -b perf kernel/xiaomi/violet
