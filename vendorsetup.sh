...
git clone --depth 1 https://Ashik6301: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@github.com/project-poison/android_kernel_xiaomi_violet.git -b perf kernel/xiaomi/violet
